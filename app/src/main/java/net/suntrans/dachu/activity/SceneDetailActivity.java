...
import net.suntrans.dachu.fragment.din.ChangSceneNameDialogFragment;
...
import static net.suntrans.dachu.utils.UiUtils.getContext;
...
//            dialog.setContentView(view);
    ...
    class MyAdapter extends BaseQuickAdapter<SceneChannelResult.SceneChannel, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder helper, SceneChannelResult.SceneChannel item) {
            ...
            if (item.channel_type.equals("1")){
                view.setImageResource(R.drawable.ic_light);
            }else if (item.channel_type.equals("2")){
