...
import net.suntrans.dachu.activity.BasedActivity;
...
import static net.suntrans.dachu.BuildConfig.DEBUG;
...
public class MainActivity extends BasedActivity {
    ...
    private final int[] TAB_IMGS = new int[]{R.drawable.select_home, R.drawable.select_area,
            R.drawable.select_env,R.drawable.select_power  ,
