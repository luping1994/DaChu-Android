...
import net.suntrans.dachu.converter.MyGsonConverterFactory;
...
public class RetrofitHelper {
    ...
    public static final String BASE_URL = "http://dcw.suntrans-cloud.com/api/v1/";

    public static final String BASE_URL2 = "http://dcw.suntrans-cloud.com/";
