...
import net.suntrans.dachu.activity.AddSceneActivity;
import net.suntrans.dachu.activity.FloorPlanActivity;
...
import net.suntrans.dachu.fragment.din.SceneFragment;
