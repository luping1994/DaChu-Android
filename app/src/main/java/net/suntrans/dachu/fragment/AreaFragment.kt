...
import net.suntrans.dachu.activity.AddAreaActivity
import net.suntrans.dachu.activity.AddFloorActivity
import net.suntrans.dachu.activity.AreaDetailActivity
import net.suntrans.dachu.adapter.AreaAdapter
...
import net.suntrans.dachu.fragment.base.BasedFragment
import net.suntrans.dachu.rx.BaseSubscriber
import net.suntrans.dachu.utils.ActivityUtils
...
import net.suntrans.dachu.views.ScrollChildSwipeRefreshLayout
