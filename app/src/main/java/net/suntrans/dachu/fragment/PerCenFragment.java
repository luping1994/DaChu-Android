package net.suntrans.dachu.fragment;
...
import net.suntrans.dachu.App;
import net.suntrans.dachu.MainActivity;
import net.suntrans.dachu.R;
import net.suntrans.dachu.activity.AboutActivity;
import net.suntrans.dachu.activity.ChangePassActivity;
import net.suntrans.dachu.activity.DeviceManagerActivity;
import net.suntrans.dachu.activity.LoginActivity;
import net.suntrans.dachu.activity.QuestionActivity;
import net.suntrans.dachu.activity.YichangActivity;
...
import net.suntrans.dachu.fragment.base.LazyLoadFragment;
import net.suntrans.dachu.fragment.din.ChangeNameDialogFragment;
import net.suntrans.dachu.fragment.din.UpLoadImageFragment;
import net.suntrans.dachu.rx.BaseSubscriber;
import net.suntrans.dachu.utils.LogUtil;
import net.suntrans.dachu.utils.StatusBarCompat;
import net.suntrans.dachu.utils.UiUtils;
import net.suntrans.dachu.views.LoadingDialog;
